...
componentDidMount(){
   ...
   this.setState({ currentUser: JSON.parse(sessionStorage.getItem('foundUser'))})
        }
  ...
  if( word === 'signup'){
    ...
    render(){
      ...
      <div>
                  ...
                  {this.state.login?  <Login handleSubmit={this.handleLogIn} handleChange={this.handleChange} username={this.state.username}  password={this.state.password}/> : null}
          <div id="buttons">
