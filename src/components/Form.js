        ...
        return (
            <div>
             <form onSubmit={this.addWeapon}>
                <input type="text" ref= "weaponsystem" name="weaponsystem" placeholder="Tank or Plane Only" value={this.state.weaponsystem} onChange={this.handleChange} />
                <input type="text" ref= "name" name="name" placeholder="Weapon Name" value={this.state.name} onChange={this.handleChange} />
                <input type="text" ref= "imgurl" name="imgurl" placeholder="Image" value={this.state.imgurl} onChange={this.handleChange} />
                <input type="text"  ref= "role" name="role" placeholder="Role" value={this.state.role} onChange={this.handleChange} />
