            ...
            <Segment.Group stacked>
              <Segment inverted>
                <input
                  ...
                  ref="weaponsystem"
                  name="weaponsystem"
                  placeholder="Tank or Plane Only"
                  value={this.state.weaponsystem}
                ...
                <input
                  ...
                  max="5"
                  name="firepowergun"
                  placeholder="Gun Firepower"
                  value={this.state.firepowergun}
                  onChange={this.handleChange}
                />
                <input
                  type="number"
